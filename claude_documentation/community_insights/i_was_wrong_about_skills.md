...
The 200-line limit isn't arbitrary. It's based on how much context an LLM can efficiently scan to decide what to load next. Keep the entry point under ~200 lines, and Claude can quickly:
...
Scan metadata → Is this capability relevant to current task?

Read entry point → What workflow patterns does this enable?

Load specific reference → Get implementation details for current step
